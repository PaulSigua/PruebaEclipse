...
a persistence unit "prueba63SiguaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba63Sigua/pom.xml":
...
artifact ("prueba63Sigua.war") is already built. You can build
